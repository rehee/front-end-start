...
Component.options.__file = "/Users/xudonghao/Desktop/test/learn-angular/front-end-start/front-end-start/script-code/vue/vapp.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vapp.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3dbb2e25", Component.options)
  } else {
    hotAPI.reload("data-v-3dbb2e25", Component.options)
  }
})()}
...
module.exports = __webpack_require__(23).default.vueComponentOptions;
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"vapp.vue","sourceRoot":""}]);
...
var VueTypescriptComponentData = (function () {
    function VueTypescriptComponentData() {
        this.props = {};
        this.watch = {};
        this.injected = {};
    }
    return VueTypescriptComponentData;
}());
exports.VueTypescriptComponentData = VueTypescriptComponentData;
...
function getOrCreateComponent(target) {
 ...
 */
function watch(expression, options) {
    if (options === void 0) { options = {}; }
    return function (target, member) {
        var wo = new WatchOptions();
        wo.expression = expression;
        wo.options = options;
        var watch = getOrCreateComponent(target).watch;
        if (!watch[member]) {
            watch[member] = [];
        }
...
exports.watch = watch;
var lifecycleHooks = ['beforeCreate', 'created', 'beforeMount', 'mounted',
...
function component(options) {
    if (options === void 0) { options = {}; }
    return function (cls) {
        var d = getOrCreateComponent(cls.prototype);
        var superOptions = cls.vueComponentOptions || {};
        var obj = new cls();
        cls.vueComponentOptions = options;
        options.name = options.name || cls.name;
        ...
        options.data = function () {
            var newData = new cls();
            var r = {};
            for (var _i = 0, _a = Object.getOwnPropertyNames(newData); _i < _a.length; _i++) {
                var n = _a[_i];
        ...
        for (var _i = 0, _a = Object.getOwnPropertyNames(d.props); _i < _a.length; _i++) {
            var n = _a[_i];
            props[n] = d.props[n];
        }
        ...
        // methods
        for (var _d = 0, _e = Object.getOwnPropertyNames(cls.prototype); _d < _e.length; _d++) {
            var n = _e[_d];
            if (n === 'constructor' || n === '$$vueTypescriptComponentData') {
                continue;
            }
            var pd = Object.getOwnPropertyDescriptor(cls.prototype, n);
            if (pd.set) {
        ...
        // watch
        for (var _f = 0, _g = Object.getOwnPropertyNames(d.watch); _f < _g.length; _f++) {
            var n = _g[_f];
            if (!options.methods[n]) {
                throw '@watch must decorate a method: ' + cls.name + '.' + n;
            }
            for (var _h = 0, _j = d.watch[n]; _h < _j.length; _h++) {
                var o = _j[_h];
...
var VApp = __webpack_require__(5);
new Vue({
    el: '#app',
    render: function (h) { return h(VApp); },
});
...
Object.defineProperty(exports, "__esModule", { value: true });
var Vue = __webpack_require__(0);
var vts = __webpack_require__(20);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3dbb2e25", module.exports)
  }
}
...
var update = __webpack_require__(18)("2c4e4c81", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-3dbb2e25\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vapp.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-3dbb2e25\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./vapp.vue");
